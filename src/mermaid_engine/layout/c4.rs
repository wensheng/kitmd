...
pub(super) fn compute_c4_layout(graph: &Graph, config: &LayoutConfig) -> Layout {
    ...
    let mut shape_map: std::collections::HashMap<String, &crate::mermaid_engine::ir::C4Shape> =
        std::collections::HashMap::new();
    ...
    let mut boundaries_by_parent: std::collections::HashMap<String, Vec<String>> =
        std::collections::HashMap::new();
    let mut boundary_map: std::collections::HashMap<
        String,
        &crate::mermaid_engine::ir::C4Boundary,
    > = std::collections::HashMap::new();
    ...
    for rel in &rels_out {
        edges.push(EdgeLayout {
            ...
            directed: rel.kind != crate::mermaid_engine::ir::C4RelKind::BiRel,
            arrow_start: false,
            arrow_end: rel.kind != crate::mermaid_engine::ir::C4RelKind::BiRel,
...
impl C4Bounds {
    fn new(conf: &crate::mermaid_engine::config::C4Config) -> Self {
        Self {
            data: C4BoundsData {
                startx: 0.0,
                stopx: 0.0,
...
fn layout_c4_boundaries(
    ...
    shape_map: &std::collections::HashMap<String, &crate::mermaid_engine::ir::C4Shape>,
    boundaries_by_parent: &std::collections::HashMap<String, Vec<String>>,
    boundary_map: &std::collections::HashMap<String, &crate::mermaid_engine::ir::C4Boundary>,
    conf: &crate::mermaid_engine::config::C4Config,
    fast_metrics: bool,
) {
...
fn c4_text_line_height(conf: &crate::mermaid_engine::config::C4Config, font_size: f32) -> f32 {
