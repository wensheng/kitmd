...
use crate::mermaid_engine::ir::Direction;
...
pub struct NodeLayout {
    ...
    pub height: f32,
    pub label: TextBlock,
    pub shape: crate::mermaid_engine::ir::NodeShape,
    pub style: crate::mermaid_engine::ir::NodeStyle,
    pub link: Option<crate::mermaid_engine::ir::NodeLink>,
...
pub struct EdgeLayout {
    ...
    pub arrow_end: bool,
    pub arrow_start_kind: Option<crate::mermaid_engine::ir::EdgeArrowhead>,
    pub arrow_end_kind: Option<crate::mermaid_engine::ir::EdgeArrowhead>,
    pub start_decoration: Option<crate::mermaid_engine::ir::EdgeDecoration>,
    pub end_decoration: Option<crate::mermaid_engine::ir::EdgeDecoration>,
    pub style: crate::mermaid_engine::ir::EdgeStyle,
    pub override_style: crate::mermaid_engine::ir::EdgeStyleOverride,
}
...
pub struct SequenceFrameLayout {
    pub kind: crate::mermaid_engine::ir::SequenceFrameKind,
    pub x: f32,
    pub y: f32,
    pub width: f32,
    pub height: f32,
...
pub struct SequenceNoteLayout {
    ...
    pub height: f32,
    pub label: TextBlock,
    pub position: crate::mermaid_engine::ir::SequenceNotePosition,
...
pub struct StateNoteLayout {
    ...
    pub height: f32,
    pub label: TextBlock,
    pub position: crate::mermaid_engine::ir::StateNotePosition,
    pub target: String,
}
...
pub struct GitGraphCommitLayout {
    ...
    pub y: f32,
    pub axis_pos: f32,
    pub commit_type: crate::mermaid_engine::ir::GitGraphCommitType,
    pub custom_type: Option<crate::mermaid_engine::ir::GitGraphCommitType>,
...
pub struct TimelineLayout {
    ...
    pub direction: crate::mermaid_engine::ir::Direction,
    pub line_y: f32,
...
#[derive(Debug, Clone)]
pub struct Layout {
    pub kind: crate::mermaid_engine::ir::DiagramKind,
...
pub struct C4ShapeLayout {
    pub id: String,
    pub kind: crate::mermaid_engine::ir::C4ShapeKind,
...
pub struct C4RelLayout {
    pub kind: crate::mermaid_engine::ir::C4RelKind,
    pub from: String,
    pub to: String,
    pub label: C4TextLayout,
...
pub struct GanttTaskLayout {
    ...
    pub start: f32,
    pub duration: f32,
    pub status: Option<crate::mermaid_engine::ir::GanttStatus>,
}
