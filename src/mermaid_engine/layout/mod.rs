...
use crate::mermaid_engine::config::{LayoutConfig, PieRenderMode, TreemapRenderMode};
...
pub fn compute_layout_with_metrics(
    ...
    let mut layout = match graph.kind {
        ...
        | crate::mermaid_engine::ir::DiagramKind::ZenUML => {
            compute_sequence_layout(graph, theme, config)
        }
        crate::mermaid_engine::ir::DiagramKind::Pie => {
        ...
        crate::mermaid_engine::ir::DiagramKind::Quadrant => {
            compute_quadrant_layout(graph, theme, config)
        }
        crate::mermaid_engine::ir::DiagramKind::Gantt => compute_gantt_layout(graph, theme, config),
        crate::mermaid_engine::ir::DiagramKind::Kanban => {
            compute_kanban_layout(graph, theme, config, Some(&mut stage_metrics))
        }
        crate::mermaid_engine::ir::DiagramKind::Block => compute_block_layout(graph, theme, config),
        crate::mermaid_engine::ir::DiagramKind::Sankey => {
            compute_sankey_layout(graph, theme, config)
        }
        crate::mermaid_engine::ir::DiagramKind::Architecture => {
            compute_architecture_layout(graph, theme, config)
        }
        crate::mermaid_engine::ir::DiagramKind::Radar => compute_radar_layout(graph, theme, config),
        crate::mermaid_engine::ir::DiagramKind::Treemap => {
        ...
        crate::mermaid_engine::ir::DiagramKind::GitGraph => {
            compute_gitgraph_layout(graph, theme, config)
        }
        crate::mermaid_engine::ir::DiagramKind::C4 => compute_c4_layout(graph, config),
        crate::mermaid_engine::ir::DiagramKind::Mindmap => {
            compute_mindmap_layout(graph, theme, config)
        }
        crate::mermaid_engine::ir::DiagramKind::XYChart => {
            compute_xychart_layout(graph, theme, config)
        }
        crate::mermaid_engine::ir::DiagramKind::Timeline => {
            compute_timeline_layout(graph, theme, config)
        }
        crate::mermaid_engine::ir::DiagramKind::Journey => {
            compute_journey_layout(graph, theme, config)
        }
        crate::mermaid_engine::ir::DiagramKind::Class
        | crate::mermaid_engine::ir::DiagramKind::State
        | crate::mermaid_engine::ir::DiagramKind::Er
        | crate::mermaid_engine::ir::DiagramKind::Requirement
        | crate::mermaid_engine::ir::DiagramKind::Packet
...
fn compute_flowchart_layout(
    ...
    if graph.kind == crate::mermaid_engine::ir::DiagramKind::Class {
    ...
    for node in graph.nodes.values() {
        ...
        if graph.kind == crate::mermaid_engine::ir::DiagramKind::State
            && label_empty
            && matches!(
                node.shape,
        ...
        } else if graph.kind == crate::mermaid_engine::ir::DiagramKind::State {
    ...
    if graph.kind == crate::mermaid_engine::ir::DiagramKind::State && !state_marker_ids.is_empty() {
    ...
    let mut layout_edges: Vec<crate::mermaid_engine::ir::Edge> =
    ...
    let measure_edge_field = |field: &Option<String>| -> Option<TextBlock> {
        field.as_ref().map(|label| {
            let label_text = if graph.kind == crate::mermaid_engine::ir::DiagramKind::Requirement {
    ...
    if graph.kind == crate::mermaid_engine::ir::DiagramKind::State && !graph.subgraphs.is_empty() {
...
pub(in crate::mermaid_engine::layout) fn resolve_edge_style(
    idx: usize,
    graph: &Graph,
) -> crate::mermaid_engine::ir::EdgeStyleOverride {
...
fn merge_edge_style(
    target: &mut crate::mermaid_engine::ir::EdgeStyleOverride,
    source: &crate::mermaid_engine::ir::EdgeStyleOverride,
) {
...
pub(in crate::mermaid_engine::layout) fn bounds_with_edges(
    nodes: &BTreeMap<String, NodeLayout>,
    subgraphs: &[SubgraphLayout],
    edges: &[EdgeLayout],
) -> (f32, f32) {
...
pub(in crate::mermaid_engine::layout) fn apply_direction_mirror(
    direction: Direction,
    nodes: &mut BTreeMap<String, NodeLayout>,
...
pub(in crate::mermaid_engine::layout) fn normalize_layout(
    nodes: &mut BTreeMap<String, NodeLayout>,
    edges: &mut [EdgeLayout],
    subgraphs: &mut [SubgraphLayout],
) {
...
fn resolve_node_style(node_id: &str, graph: &Graph) -> crate::mermaid_engine::ir::NodeStyle {
...
fn build_node_layout(
    node: &crate::mermaid_engine::ir::Node,
    label: TextBlock,
    width: f32,
    height: f32,
    style: crate::mermaid_engine::ir::NodeStyle,
    graph: &Graph,
) -> NodeLayout {
    NodeLayout {
        id: node.id.clone(),
...
fn merge_node_style(
    target: &mut crate::mermaid_engine::ir::NodeStyle,
    source: &crate::mermaid_engine::ir::NodeStyle,
) {
...
fn shape_padding_factors(shape: crate::mermaid_engine::ir::NodeShape) -> (f32, f32) {
    match shape {
        crate::mermaid_engine::ir::NodeShape::Stadium => (0.43, 0.5),
        crate::mermaid_engine::ir::NodeShape::Subroutine => (0.54, 0.5),
        crate::mermaid_engine::ir::NodeShape::Parallelogram => (0.894, 0.5),
        crate::mermaid_engine::ir::NodeShape::ParallelogramAlt => (0.904, 0.5),
        _ => (1.0, 1.0),
    }
}
...
fn shape_size(
    shape: crate::mermaid_engine::ir::NodeShape,
    label: &TextBlock,
    config: &LayoutConfig,
    theme: &Theme,
    ...
    let (kind_pad_x_scale, kind_pad_y_scale) = match kind {
        ...
        crate::mermaid_engine::ir::DiagramKind::Er => (1.05, 1.15),
        crate::mermaid_engine::ir::DiagramKind::Kanban => (2.3, 0.67),
        crate::mermaid_engine::ir::DiagramKind::Requirement => (0.1, 1.0),
        crate::mermaid_engine::ir::DiagramKind::Block => (0.5, 0.35),
        _ => (1.0, 1.0),
    };
    ...
    if kind == crate::mermaid_engine::ir::DiagramKind::State {
        let dynamic_pad_x =
    ...
    match shape {
        ...
        crate::mermaid_engine::ir::NodeShape::ForkJoin => {
    ...
    if kind == crate::mermaid_engine::ir::DiagramKind::Class {
        let min_height = theme.font_size * CLASS_MIN_HEIGHT_SCALE;
        height = height.max(min_height);
    }

    if kind == crate::mermaid_engine::ir::DiagramKind::Requirement {
        let min_width = theme.font_size * REQUIREMENT_MIN_WIDTH_SCALE;
        width = width.max(min_width);
    }

    if kind == crate::mermaid_engine::ir::DiagramKind::Kanban {
...
mod tests {
    use super::*;
    use crate::mermaid_engine::ir::{Direction, Graph, NodeShape};
    use crate::mermaid_engine::layout::ranking::rank_edges_for_manual_layout;
    use crate::mermaid_engine::parser::parse_mermaid;
    ...
    fn sequence_layout_normalizes_missing_participants() {
        let mut graph = Graph::new();
        graph.kind = crate::mermaid_engine::ir::DiagramKind::Sequence;
...
"#,
    ...
    fn edge_style_merges_default_and_override() {
        ...
        graph.edge_style_default = Some(crate::mermaid_engine::ir::EdgeStyleOverride {
...
"#,
    ...
    fn compact_large_flowchart_whitespace_reduces_main_axis_spread() {
        let mut graph = Graph::new();
        graph.kind = crate::mermaid_engine::ir::DiagramKind::Flowchart;
        graph.direction = Direction::LeftRight;
    ...
    fn rank_edges_prefers_non_dotted_flow_edges_when_coverage_is_good() {
        ...
        let edges = vec![
            make_edge("A", "B", crate::mermaid_engine::ir::EdgeStyle::Solid),
            make_edge("B", "C", crate::mermaid_engine::ir::EdgeStyle::Solid),
            make_edge("C", "D", crate::mermaid_engine::ir::EdgeStyle::Solid),
            make_edge("A", "D", crate::mermaid_engine::ir::EdgeStyle::Dotted),
        ];
        ...
        assert!(
            rank_edges
                .iter()
                .all(|edge| edge.style != crate::mermaid_engine::ir::EdgeStyle::Dotted)
        );
    }
    ...
    fn rank_edges_falls_back_when_primary_coverage_is_too_small() {
        ...
        let edges = vec![
            make_edge("A", "B", crate::mermaid_engine::ir::EdgeStyle::Solid),
            make_edge("C", "D", crate::mermaid_engine::ir::EdgeStyle::Dotted),
            make_edge("D", "E", crate::mermaid_engine::ir::EdgeStyle::Dotted),
            make_edge("E", "C", crate::mermaid_engine::ir::EdgeStyle::Dotted),
        ];
        let rank_edges = rank_edges_for_manual_layout(&graph, &nodes, &edges);
