...
pub(in crate::mermaid_engine::layout) fn apply_visual_objectives(
    graph: &Graph,
...
pub(in crate::mermaid_engine::layout) fn compact_large_flowchart_whitespace(
    graph: &Graph,
    nodes: &mut BTreeMap<String, NodeLayout>,
    config: &LayoutConfig,
) {
...
fn shift_cross_subgraph_flowchart_group(
    ...
    edge: &crate::mermaid_engine::ir::Edge,
    nodes: &mut BTreeMap<String, NodeLayout>,
    horizontal: bool,
    main_delta: f32,
    delta: f32,
...
mod tests {
    ...
    use crate::mermaid_engine::layout::{NodeLayout, TextBlock};
    use crate::mermaid_engine::theme::Theme;
