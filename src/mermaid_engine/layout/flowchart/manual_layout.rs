...
fn build_ordering_edges(
    layout_edges: &[crate::mermaid_engine::ir::Edge],
...
) -> Vec<crate::mermaid_engine::ir::Edge> {
    let mut ordering_edges: Vec<crate::mermaid_engine::ir::Edge> = Vec::new();
    ...
    for (edge_idx, edge) in layout_edges.iter().enumerate() {
        ...
        for step in 1..span {
            ...
            ordering_edges.push(crate::mermaid_engine::ir::Edge {
                from: prev.clone(),
                to: dummy_id.clone(),
                label: None,
                start_label: None,
...
pub(in crate::mermaid_engine::layout) fn assign_positions_manual(
    graph: &Graph,
    ...
    let layout_edges: Vec<crate::mermaid_engine::ir::Edge> = layout_edges
        .iter()
        .enumerate()
...
mod tests {
    ...
    fn make_graph_node(id: &str) -> crate::mermaid_engine::ir::Node {
        crate::mermaid_engine::ir::Node {
            id: id.to_string(),
            label: id.to_string(),
            shape: crate::mermaid_engine::ir::NodeShape::Rectangle,
            value: None,
    ...
    fn make_edge(from: &str, to: &str, label: Option<&str>) -> crate::mermaid_engine::ir::Edge {
    ...
    fn non_flowchart_layouts_can_insert_label_dummy_nodes() {
        ...
        graph.direction = crate::mermaid_engine::ir::Direction::TopDown;
