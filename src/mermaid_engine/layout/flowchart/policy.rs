...
pub(in crate::mermaid_engine::layout) fn apply_initial_config_heuristics(
    graph: &Graph,
    config: &LayoutConfig,
) -> LayoutConfig {
...
pub(in crate::mermaid_engine::layout) fn apply_measured_spacing_heuristics(
    graph: &Graph,
    theme: &Theme,
...
pub(in crate::mermaid_engine::layout) fn is_tiny_graph_layout(graph: &Graph) -> bool {
