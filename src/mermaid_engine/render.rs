...
#[cfg(feature = "png")]
use crate::mermaid_engine::config::RenderConfig;
use crate::mermaid_engine::layout::label_placement::{
    edge_endpoint_label_position, edge_label_padding, endpoint_label_padding,
};
use crate::mermaid_engine::layout::{
...
use crate::mermaid_engine::text_metrics;
use crate::mermaid_engine::theme::{Theme, adjust_color, parse_color_to_hsl};
use anyhow::Result;
...
pub fn arrowhead_inset(
    kind: crate::mermaid_engine::ir::DiagramKind,
    arrow_kind: Option<crate::mermaid_engine::ir::EdgeArrowhead>,
) -> f32 {
    crate::mermaid_engine::edge_geometry::arrowhead_inset(kind, arrow_kind)
}
...
pub fn render_svg_with_dimensions(
    ...
    let state_font_size = if layout.kind == crate::mermaid_engine::ir::DiagramKind::State {
    ...
    let (width, height, viewbox_x, viewbox_y, viewbox_width, viewbox_height) =
        ...
        } else if layout.kind == crate::mermaid_engine::ir::DiagramKind::Requirement {
        ...
        } else if layout.kind == crate::mermaid_engine::ir::DiagramKind::Mindmap {
    ...
    let is_state = layout.kind == crate::mermaid_engine::ir::DiagramKind::State;
    let is_class = layout.kind == crate::mermaid_engine::ir::DiagramKind::Class;
    ...
    if dimensions.is_none() && !matches!(layout.diagram, DiagramData::Error(_)) {
        ...
        } else if layout.kind == crate::mermaid_engine::ir::DiagramKind::Pie
            && config.pie.use_max_width
        {
            width_attr = "100%".to_string();
            height_attr.clear();
            style_attr = format!(
    ...
    if layout.kind == crate::mermaid_engine::ir::DiagramKind::Architecture {
        svg.push_str(&render_architecture(layout, theme, config, &color_ids));
        svg.push_str("</svg>");
        return svg;
    }

    if layout.kind == crate::mermaid_engine::ir::DiagramKind::Radar {
        svg.push_str(&render_radar(layout, theme, config));
        svg.push_str("</svg>");
        return svg;
    }

    if layout.kind == crate::mermaid_engine::ir::DiagramKind::Requirement {
    ...
    let overlay_flowchart = layout.kind == crate::mermaid_engine::ir::DiagramKind::Flowchart;
    ...
    if is_sequence {
        ...
        let base_edge_width = match layout.kind {
            crate::mermaid_engine::ir::DiagramKind::Class
            | crate::mermaid_engine::ir::DiagramKind::State
            | crate::mermaid_engine::ir::DiagramKind::Er => 1.0,
            _ => 2.0,
        };
        for (edge_idx, edge) in layout.edges.iter().enumerate() {
            ...
            let (mut dash, mut stroke_width) = match edge.style {
                crate::mermaid_engine::ir::EdgeStyle::Solid => (String::new(), base_edge_width),
                crate::mermaid_engine::ir::EdgeStyle::Dotted => {
                    ("stroke-dasharray=\"4 4\"".to_string(), base_edge_width)
                }
                crate::mermaid_engine::ir::EdgeStyle::Thick => (String::new(), 3.5),
            };
            ...
            let marker_end = if edge.arrow_end && !overlay_flowchart {
                match layout.kind {
                    ...
                    crate::mermaid_engine::ir::DiagramKind::Class => match edge.arrow_end_kind {
                        Some(crate::mermaid_engine::ir::EdgeArrowhead::OpenTriangle) => {
                            format!("marker-end=\"url(#arrow-class-open-{marker_id})\"")
                        }
                        Some(crate::mermaid_engine::ir::EdgeArrowhead::ClassDependency) => {
            ...
            let marker_start = if edge.arrow_start && !overlay_flowchart {
                match layout.kind {
                    ...
                    crate::mermaid_engine::ir::DiagramKind::Class => match edge.arrow_start_kind {
                        Some(crate::mermaid_engine::ir::EdgeArrowhead::OpenTriangle) => {
                ...
                && let Some((x, y)) = edge.label_anchor
            {
                ...
                let (fill_opacity, stroke_opacity) = match layout.kind {
                    crate::mermaid_engine::ir::DiagramKind::State => (0.7, 0.25),
                    crate::mermaid_engine::ir::DiagramKind::Flowchart => (0.95, 0.45),
                    _ => (0.85, 0.35),
                };
                let label_scale = if layout.kind == crate::mermaid_engine::ir::DiagramKind::State {
                ...
                if layout.kind == crate::mermaid_engine::ir::DiagramKind::State {
                    svg.push_str(&format!(
                        "<g class=\"edgeLabel\" data-edge-id=\"{edge_id}\" data-label-kind=\"center\">"
                    ));
                    svg.push_str(&text_block_svg_with_font_size(
            ...
            let (endpoint_fill_opacity, endpoint_stroke_opacity) = match layout.kind {
                crate::mermaid_engine::ir::DiagramKind::State => (0.7, 0.25),
                crate::mermaid_engine::ir::DiagramKind::Flowchart => (0.95, 0.45),
                crate::mermaid_engine::ir::DiagramKind::Class => (0.9, 0.4),
                _ => (0.85, 0.35),
            };
    ...
    if !is_sequence {
        let mut nodes_to_draw: Vec<&crate::mermaid_engine::layout::NodeLayout> =
            if layout.kind == crate::mermaid_engine::ir::DiagramKind::Treemap {
                let mut nodes: Vec<&crate::mermaid_engine::layout::NodeLayout> =
        ...
        for node in nodes_to_draw.drain(..) {
            ...
            if layout.kind == crate::mermaid_engine::ir::DiagramKind::Er {
            ...
            if layout.kind != crate::mermaid_engine::ir::DiagramKind::Er {
                let divider_line_height =
                    if layout.kind == crate::mermaid_engine::ir::DiagramKind::Class {
            ...
            if !hide_label {
                let label_svg = if layout.kind == crate::mermaid_engine::ir::DiagramKind::Treemap {
                ...
                } else if layout.kind == crate::mermaid_engine::ir::DiagramKind::Er {
                ...
                } else if layout.kind == crate::mermaid_engine::ir::DiagramKind::State {
...
fn edge_label_background_visible(
    diagram_kind: crate::mermaid_engine::ir::DiagramKind,
    ...
    match label_kind {
        EdgeLabelKind::Center => {
            let gap_limit = match diagram_kind {
                crate::mermaid_engine::ir::DiagramKind::Flowchart => 1.2,
                crate::mermaid_engine::ir::DiagramKind::Sequence => {
                    (rect.height * 0.16).clamp(1.2, 2.4)
                }
                crate::mermaid_engine::ir::DiagramKind::Requirement => 1.0,
                _ => 0.9,
            };
            gap <= gap_limit
        }
        EdgeLabelKind::Start | EdgeLabelKind::End => match diagram_kind {
            crate::mermaid_engine::ir::DiagramKind::Sequence => {
                gap <= (rect.height * 0.12).clamp(0.6, 1.4)
            }
            crate::mermaid_engine::ir::DiagramKind::Flowchart
            | crate::mermaid_engine::ir::DiagramKind::Requirement => gap <= 0.35,
            _ => false,
        },
    }
}
...
fn render_quadrant(
    layout: &crate::mermaid_engine::layout::QuadrantLayout,
    theme: &Theme,
    config: &LayoutConfig,
) -> String {
    let mut svg = String::new();
...
fn render_gantt(
    layout: &crate::mermaid_engine::layout::GanttLayout,
    theme: &Theme,
    config: &LayoutConfig,
) -> String {
    let mut svg = String::new();
    ...
    for task in &layout.tasks {
        ...
        if matches!(
            task.status,
            Some(crate::mermaid_engine::ir::GanttStatus::Milestone)
        ) {
...
fn render_xychart(
    layout: &crate::mermaid_engine::layout::XYChartLayout,
    theme: &Theme,
    config: &LayoutConfig,
) -> String {
    let mut svg = String::new();
...
fn render_timeline(
    layout: &crate::mermaid_engine::layout::TimelineLayout,
    theme: &Theme,
    config: &LayoutConfig,
) -> String {
    let mut svg = String::new();
    ...
    for (i, event) in layout.events.iter().enumerate() {
        ...
        let vertical = layout.direction == crate::mermaid_engine::ir::Direction::TopDown;
...
fn render_gitgraph(gitgraph: &GitGraphLayout, theme: &Theme, config: &LayoutConfig) -> String {
    ...
    if gg.show_branches {
        for branch in &gitgraph.branches {
            let (x1, y1, x2, y2) = match gitgraph.direction {
                crate::mermaid_engine::ir::Direction::TopDown => {
                    (branch.pos, gg.default_pos, branch.pos, gitgraph.max_pos)
                }
                crate::mermaid_engine::ir::Direction::BottomTop => {
    ...
    for commit in &gitgraph.commits {
        ...
        match commit_symbol_type {
            crate::mermaid_engine::ir::GitGraphCommitType::Highlight => {
            ...
            crate::mermaid_engine::ir::GitGraphCommitType::CherryPick => {
                svg.push_str(&format!(
            ...
            _ => {
                let radius =
                    if commit.commit_type == crate::mermaid_engine::ir::GitGraphCommitType::Merge {
                ...
                if commit_symbol_type == crate::mermaid_engine::ir::GitGraphCommitType::Merge {
                    svg.push_str(&format!(
                        "<circle cx=\"{:.2}\" cy=\"{:.2}\" r=\"{:.2}\" fill=\"{}\" stroke=\"{}\"/>",
                        commit.x,
                        commit.y,
                ...
                if commit_symbol_type == crate::mermaid_engine::ir::GitGraphCommitType::Reverse {
...
fn render_c4_shape(
    shape: &C4ShapeLayout,
    conf: &crate::mermaid_engine::config::C4Config,
) -> String {
    ...
    match shape.kind {
        crate::mermaid_engine::ir::C4ShapeKind::SystemDb
        | crate::mermaid_engine::ir::C4ShapeKind::ExternalSystemDb
        ...
        crate::mermaid_engine::ir::C4ShapeKind::SystemQueue
        | crate::mermaid_engine::ir::C4ShapeKind::ExternalSystemQueue
        ...
        )
    {
        let icon = match shape.kind {
            crate::mermaid_engine::ir::C4ShapeKind::ExternalPerson => C4_EXTERNAL_PERSON_ICON,
            crate::mermaid_engine::ir::C4ShapeKind::Person => C4_PERSON_ICON,
            _ => C4_PERSON_ICON,
        };
        svg.push_str(&format!(
...
fn render_c4_boundary(
    boundary: &C4BoundaryLayout,
    conf: &crate::mermaid_engine::config::C4Config,
) -> String {
    let mut svg = String::new();
    svg.push_str("<g>");
...
fn render_c4_rel(
    ...
    if straight {
        ...
        if rel.kind != crate::mermaid_engine::ir::C4RelKind::RelBack {
            attrs.push_str(" marker-end=\"url(#arrowhead)\"");
        }
        if matches!(
            rel.kind,
            crate::mermaid_engine::ir::C4RelKind::BiRel
                | crate::mermaid_engine::ir::C4RelKind::RelBack
        ) {
...
fn c4_shape_colors(
    conf: &crate::mermaid_engine::config::C4Config,
    kind: crate::mermaid_engine::ir::C4ShapeKind,
) -> (&str, &str) {
    match kind {
        crate::mermaid_engine::ir::C4ShapeKind::Person => {
            (&conf.person_bg_color, &conf.person_border_color)
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalPerson => (
            &conf.external_person_bg_color,
            &conf.external_person_border_color,
        ),
        crate::mermaid_engine::ir::C4ShapeKind::System => {
            (&conf.system_bg_color, &conf.system_border_color)
        }
        crate::mermaid_engine::ir::C4ShapeKind::SystemDb => {
        ...
        crate::mermaid_engine::ir::C4ShapeKind::ExternalSystem => (
...
fn c4_shape_font_family(
    conf: &crate::mermaid_engine::config::C4Config,
    kind: crate::mermaid_engine::ir::C4ShapeKind,
) -> &str {
    match kind {
        crate::mermaid_engine::ir::C4ShapeKind::Person => &conf.person_font_family,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalPerson => &conf.external_person_font_family,
        crate::mermaid_engine::ir::C4ShapeKind::System => &conf.system_font_family,
        crate::mermaid_engine::ir::C4ShapeKind::SystemDb => &conf.system_db_font_family,
        crate::mermaid_engine::ir::C4ShapeKind::SystemQueue => &conf.system_queue_font_family,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalSystem => &conf.external_system_font_family,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalSystemDb => {
            &conf.external_system_db_font_family
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalSystemQueue => {
            &conf.external_system_queue_font_family
        }
        crate::mermaid_engine::ir::C4ShapeKind::Container => &conf.container_font_family,
        crate::mermaid_engine::ir::C4ShapeKind::ContainerDb => &conf.container_db_font_family,
        crate::mermaid_engine::ir::C4ShapeKind::ContainerQueue => &conf.container_queue_font_family,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalContainer => {
            &conf.external_container_font_family
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalContainerDb => {
            &conf.external_container_db_font_family
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalContainerQueue => {
            &conf.external_container_queue_font_family
        }
        crate::mermaid_engine::ir::C4ShapeKind::Component => &conf.component_font_family,
        crate::mermaid_engine::ir::C4ShapeKind::ComponentDb => &conf.component_db_font_family,
        crate::mermaid_engine::ir::C4ShapeKind::ComponentQueue => &conf.component_queue_font_family,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalComponent => {
            &conf.external_component_font_family
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalComponentDb => {
            &conf.external_component_db_font_family
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalComponentQueue => {
...
fn c4_shape_font_size(
    conf: &crate::mermaid_engine::config::C4Config,
    kind: crate::mermaid_engine::ir::C4ShapeKind,
) -> f32 {
    match kind {
        crate::mermaid_engine::ir::C4ShapeKind::Person => conf.person_font_size,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalPerson => conf.external_person_font_size,
        crate::mermaid_engine::ir::C4ShapeKind::System => conf.system_font_size,
        crate::mermaid_engine::ir::C4ShapeKind::SystemDb => conf.system_db_font_size,
        crate::mermaid_engine::ir::C4ShapeKind::SystemQueue => conf.system_queue_font_size,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalSystem => conf.external_system_font_size,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalSystemDb => {
            conf.external_system_db_font_size
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalSystemQueue => {
            conf.external_system_queue_font_size
        }
        crate::mermaid_engine::ir::C4ShapeKind::Container => conf.container_font_size,
        crate::mermaid_engine::ir::C4ShapeKind::ContainerDb => conf.container_db_font_size,
        crate::mermaid_engine::ir::C4ShapeKind::ContainerQueue => conf.container_queue_font_size,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalContainer => {
            conf.external_container_font_size
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalContainerDb => {
            conf.external_container_db_font_size
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalContainerQueue => {
            conf.external_container_queue_font_size
        }
        crate::mermaid_engine::ir::C4ShapeKind::Component => conf.component_font_size,
        crate::mermaid_engine::ir::C4ShapeKind::ComponentDb => conf.component_db_font_size,
        crate::mermaid_engine::ir::C4ShapeKind::ComponentQueue => conf.component_queue_font_size,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalComponent => {
            conf.external_component_font_size
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalComponentDb => {
            conf.external_component_db_font_size
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalComponentQueue => {
            conf.external_component_queue_font_size
        }
    }
}

fn c4_shape_font_weight(
    conf: &crate::mermaid_engine::config::C4Config,
    kind: crate::mermaid_engine::ir::C4ShapeKind,
) -> &str {
    match kind {
        crate::mermaid_engine::ir::C4ShapeKind::Person => &conf.person_font_weight,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalPerson => &conf.external_person_font_weight,
        crate::mermaid_engine::ir::C4ShapeKind::System => &conf.system_font_weight,
        crate::mermaid_engine::ir::C4ShapeKind::SystemDb => &conf.system_db_font_weight,
        crate::mermaid_engine::ir::C4ShapeKind::SystemQueue => &conf.system_queue_font_weight,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalSystem => &conf.external_system_font_weight,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalSystemDb => {
            &conf.external_system_db_font_weight
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalSystemQueue => {
            &conf.external_system_queue_font_weight
        }
        crate::mermaid_engine::ir::C4ShapeKind::Container => &conf.container_font_weight,
        crate::mermaid_engine::ir::C4ShapeKind::ContainerDb => &conf.container_db_font_weight,
        crate::mermaid_engine::ir::C4ShapeKind::ContainerQueue => &conf.container_queue_font_weight,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalContainer => {
            &conf.external_container_font_weight
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalContainerDb => {
            &conf.external_container_db_font_weight
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalContainerQueue => {
            &conf.external_container_queue_font_weight
        }
        crate::mermaid_engine::ir::C4ShapeKind::Component => &conf.component_font_weight,
        crate::mermaid_engine::ir::C4ShapeKind::ComponentDb => &conf.component_db_font_weight,
        crate::mermaid_engine::ir::C4ShapeKind::ComponentQueue => &conf.component_queue_font_weight,
        crate::mermaid_engine::ir::C4ShapeKind::ExternalComponent => {
            &conf.external_component_font_weight
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalComponentDb => {
            &conf.external_component_db_font_weight
        }
        crate::mermaid_engine::ir::C4ShapeKind::ExternalComponentQueue => {
...
fn link_attrs(link: &crate::mermaid_engine::ir::NodeLink) -> String {
...
fn edge_decoration_svg(
    point: (f32, f32),
    angle_deg: f32,
    decoration: crate::mermaid_engine::ir::EdgeDecoration,
    stroke: &str,
    stroke_width: f32,
    at_start: bool,
) -> String {
    ...
    if matches!(
        decoration,
        crate::mermaid_engine::ir::EdgeDecoration::Diamond
            | crate::mermaid_engine::ir::EdgeDecoration::DiamondFilled
    ) && !at_start
    {
        angle += 180.0;
    }
    ...
    let shape = match decoration {
        crate::mermaid_engine::ir::EdgeDecoration::Circle => format!(
            "<circle cx=\"0\" cy=\"0\" r=\"5\" fill=\"none\" stroke=\"{}\" stroke-width=\"{}\"/>",
            stroke, stroke_width
        ),
        crate::mermaid_engine::ir::EdgeDecoration::Cross => format!(
        ...
        crate::mermaid_engine::ir::EdgeDecoration::CrowsFootOne => format!(
            "<path d=\"M 0 -6 L 0 6 M 5 -6 L 5 6\" fill=\"none\" stroke=\"{}\" stroke-width=\"{}\"{join}/>",
            stroke, stroke_width
        ),
        crate::mermaid_engine::ir::EdgeDecoration::CrowsFootZeroOne => format!(
        ...
        crate::mermaid_engine::ir::EdgeDecoration::CrowsFootMany => format!(
            "<path d=\"M 0 -6 L 0 6 M 0 0 L 8 -6 M 0 0 L 8 6\" fill=\"none\" stroke=\"{}\" stroke-width=\"{}\"{join}/>",
            stroke, stroke_width
        ),
        crate::mermaid_engine::ir::EdgeDecoration::CrowsFootZeroMany => format!(
...
fn shape_svg(
    ...
    let h = node.height;
    match node.shape {
        crate::mermaid_engine::ir::NodeShape::Rectangle => format!(
        ...
        crate::mermaid_engine::ir::NodeShape::ForkJoin => format!(
        ...
        crate::mermaid_engine::ir::NodeShape::ActorBox => format!(
            "<rect x=\"{:.2}\" y=\"{:.2}\" width=\"{:.2}\" height=\"{:.2}\" rx=\"3\" ry=\"3\" fill=\"{}\" stroke=\"{}\" stroke-width=\"{}\"{dash}{join}/>",
            x,
            y,
            w,
        ...
        | crate::mermaid_engine::ir::NodeShape::DoubleCircle => {
            ...
            let (circle_fill, circle_stroke) = if is_state_start {
                ...
                if node.shape == crate::mermaid_engine::ir::NodeShape::Circle {
                    (
                        theme.primary_text_color.as_str(),
                        theme.primary_text_color.as_str(),
                    )
            ...
            if node.shape == crate::mermaid_engine::ir::NodeShape::DoubleCircle {
                let r2 = r - 4.0;
                if r2 > 0.0 {
        ...
        crate::mermaid_engine::ir::NodeShape::Stadium => format!(
            "<rect x=\"{:.2}\" y=\"{:.2}\" width=\"{:.2}\" height=\"{:.2}\" rx=\"{:.2}\" ry=\"{:.2}\" fill=\"{}\" stroke=\"{}\" stroke-width=\"{}\"{dash}{join}/>",
            x,
            y,
            w,
        ...
        crate::mermaid_engine::ir::NodeShape::RoundRect => format!(
        ...
        | crate::mermaid_engine::ir::NodeShape::ParallelogramAlt => {
            let offset = w * 0.18;
            let (p1, p2, p3, p4) =
                if node.shape == crate::mermaid_engine::ir::NodeShape::Parallelogram {
                    (
                        (x + offset, y),
                        (x + w, y),
                        (x + w - offset, y + h),
        ...
        | crate::mermaid_engine::ir::NodeShape::TrapezoidAlt => {
            let offset = w * 0.18;
            let (p1, p2, p3, p4) = if node.shape == crate::mermaid_engine::ir::NodeShape::Trapezoid
            {
                (
                    (x + offset, y),
                    (x + w - offset, y),
...
mod tests {
    ...
    fn flowchart_endpoint_arrow_angle_points_from_attached_node_side() {
        let node = crate::mermaid_engine::layout::NodeLayout {
            ...
            shape: crate::mermaid_engine::ir::NodeShape::Rectangle,
            style: crate::mermaid_engine::ir::NodeStyle::default(),
            link: None,
    ...
    fn mindmap_default_shape_honors_zero_corner_radius() {
        let node = crate::mermaid_engine::layout::NodeLayout {
            ...
            shape: crate::mermaid_engine::ir::NodeShape::MindmapDefault,
            style: crate::mermaid_engine::ir::NodeStyle::default(),
            link: None,
            anchor_subgraph: None,
            hidden: false,
